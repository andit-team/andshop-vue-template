        ...
        <div class="row">
          ...
          <div class="col-12 col-md-12">
            ...
            <div class="best-seller-items-wrap d-flex flex-wrap product-row">
              ...
              <div v-for="(bestSellerItem, index) in bestSellerItems" :key="index" class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 product-item-col">
