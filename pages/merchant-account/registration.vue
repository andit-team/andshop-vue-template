        ...
        <div class="col-12 col-sm-10 col-md-7 col-lg-6 col-xl-4">
          ...
          <ValidationObserver v-slot="{ handleSubmit }">
            <form class="p-4" @submit.prevent="handleSubmit(registerUser)">
              <h4 class="text-center mb-4">Merchant Registration</h4>
              ...
              <div class="form-group">
                <button @click.prevent="goMerchant()" type="submit" class="theme-button rounded w-100 justify-content-center">Register</button>
              </div>
              <p class="dont-have-account text-center">Already have an account? <nuxt-link to="/merchant-account/login">Login</nuxt-link></p>
            </form>
          </ValidationObserver>
        </div>
      </div>
