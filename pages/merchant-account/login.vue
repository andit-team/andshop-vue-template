      ...
      <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-7 col-lg-6 col-xl-4">
          ...
          <form class="p-4" @submit.prevent="userLogin">
            <h4 class="text-center mb-4">Merchant Login</h4>
            ...
            <div class="form-group form-check">
              ...
              <div class="remember-box d-flex justify-content-between">
                ...
                <nuxt-link to="/merchant-account/forget-password">Forgot password ?</nuxt-link>
              </div>
            </div>

            <div class="form-group">
              <button @click.prevent="goMerchant()" type="submit" class="theme-button rounded w-100 justify-content-center">Log In</button>
            </div>
            <p class="dont-have-account text-center">Don’t have an account? <nuxt-link to="/merchant-account/registration">Sign up</nuxt-link></p>
          </form>
        </div>
      </div>
    </div>
